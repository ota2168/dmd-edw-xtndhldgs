--populate all data to target table
--Using the new empty table to improve performance
insert into edw_tdsunset.fact_agreement_detail_initial_aifrps
...
from edw_work.aifrps_fact_agreement_detail_initial_load;
