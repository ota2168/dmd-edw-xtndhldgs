-- FOR NOW, WE WILL LOAD HISTORICAL DATA TO EDW_TDSUNSET.DIM_AGREEMENT_INITAL
-- INSTEAD OF THE EDW_TDSUNSET.DIM_AGREEMENT TO DO SOME TESTING.
-- EDW_TDSUNSET.DIM_AGREEMENT_INITIAL IS NO LONGER NEEDED
DELETE FROM EDW_TDSUNSET.DIM_AGREEMENT_INITIAL_AIF_RPS WHERE DIM_AGREEMENT_NATURAL_KEY_HASH_UUID IN
(SELECT DIM_AGREEMENT_NATURAL_KEY_HASH_UUID FROM EDW_WORK.AIFRPS_DIM_AGREEMENT_INITIAL_LOAD) AND CURRENT_ROW_IND = TRUE;

INSERT INTO EDW_TDSUNSET.DIM_AGREEMENT_INITIAL_AIF_RPS
(
...
SELECT
    ...
    SOURCE_SYSTEM_ID,
    RESTRICTED_ROW_IND
FROM EDW_WORK.AIFRPS_DIM_AGREEMENT_INITIAL_LOAD;
