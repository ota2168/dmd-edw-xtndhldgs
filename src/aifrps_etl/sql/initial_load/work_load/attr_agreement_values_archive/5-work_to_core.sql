...
INSERT INTO edw_tdsunset.attr_agreement_values_archive_aifrps --schema need to be changed
    (
...
'Initial Archival history from TD- RFC#20210820 TERSUN Agreement AIF RPS RFC' as ARCHIVE_COMMENT_TXT
FROM  prod_stnd_vw_tersun.agmt_val_data_archive_aif_rps AGMT_VAL
where SRC_SYS_ID=72
